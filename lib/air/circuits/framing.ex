defmodule Air.Circuits.Framing do
  @behaviour Circuits.UART.Framing

  @moduledoc """
  Each message is 10 bytes. This framer doesn't do anything for the transmit
  direction, but for receives, it will collect bytes in batches of 10 before
  ...
  defp process_data(<<message::binary-size(10), rest::binary>>, messages) do
